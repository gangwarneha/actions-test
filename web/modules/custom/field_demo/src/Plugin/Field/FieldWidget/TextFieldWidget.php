...
class TextFieldWidget extends WidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element['options']['desktop'] = [
      ...
      '#default_value' => !empty($item->options['desktop'])
      ? $item->options['desktop'] : FALSE,
    ];
    $element['options']['tablet'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Tablet content'),
      '#default_value' => !empty($item->options['tablet'])
      ? $item->options['tablet'] : FALSE,
    ];
    $element['options']['mobile'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Mobile content'),
      '#default_value' => !empty($item->options['mobile'])
      ? $item->options['mobile'] : FALSE,
    ];
